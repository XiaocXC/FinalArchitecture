package com.zjl.library_network.utils.okhttp
...
class Progress {
    ...
    fun totalSize(): String {
        ...
        return Formatter.formatFileSize(globalContext, totalBytes)
    }
    ...
    fun currentSize(): String {
        return Formatter.formatFileSize(globalContext, currentByteCount)
    }
    ...
    fun remainSize(): String {
        ...
        return Formatter.formatFileSize(globalContext, remain)
    }
    ...
    fun speedSize(): String {
        return Formatter.formatFileSize(globalContext, speedBytes)
    }
