...
sealed class PagingUiModel<T>(
    ...
    data class Loading<T>(override val refresh: Boolean, val data: List<T>? = null) : PagingUiModel<T>(refresh){
    ...
    data class Error<T>(val error: Throwable, override val refresh: Boolean, val data: List<T>? = null) : PagingUiModel<T>(refresh){
