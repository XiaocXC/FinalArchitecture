...
public class TreeViewList extends ListView {
    private static final int DEFAULT_COLLAPSED_RESOURCE = R.drawable.ic_folder_collapse_tip;
    private static final int DEFAULT_EXPANDED_RESOURCE = R.drawable.ic_folder_expand_tip;
