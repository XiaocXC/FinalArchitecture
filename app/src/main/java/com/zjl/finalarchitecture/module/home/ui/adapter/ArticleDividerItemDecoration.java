 ...
 * </pre>
 */
public class ArticleDividerItemDecoration extends ItemDecoration {
    ...
    public ArticleDividerItemDecoration(@NonNull Context context, int orientation) {
        this(context, null, orientation);
    }

    public ArticleDividerItemDecoration(
...
//                        .getDefaultColor();
        color = context.getColor(com.zjl.finalarchitecture.R.color.base_grey_300);
        thickness =
