    ...
    private val appBarStateChangeListener =  object: AppBarStateChangeListener(){
        ...
        override fun onStateChanged(appBarLayout: AppBarLayout, state: Int, verticalOffset: Int) {
            if(state == COLLAPSED){
                ...
                mBinding.coinRulesHelp.imageTintList = ColorStateList.valueOf(requireContext().getAttrColor(R.attr.colorOnSurface))
                mBinding.coinRanking.imageTintList = ColorStateList.valueOf(requireContext().getAttrColor(R.attr.colorOnSurface))
            } else {
                ...
                mBinding.coinRulesHelp.imageTintList = ColorStateList.valueOf(requireContext().getAttrColor(R.attr.colorSurface))
                mBinding.coinRanking.imageTintList = ColorStateList.valueOf(requireContext().getAttrColor(R.attr.colorSurface))
            }
        }
